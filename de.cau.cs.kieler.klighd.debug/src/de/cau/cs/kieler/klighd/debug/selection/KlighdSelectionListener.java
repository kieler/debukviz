...
public class KlighdSelectionListener implements ISelectionListener {
    ...
    public void getLinkedList(LinkedList<Integer> list, IVariable header) throws DebugException {
        IVariable next = getValue(header,"next");
        // Get element field
        IVariable[] elements = getValue(next, "element").getValue().getVariables();
    ...
    public IVariable getValue(IVariable variable, String field) throws DebugException {
